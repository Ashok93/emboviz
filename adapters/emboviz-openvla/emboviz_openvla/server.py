...
When ``emboviz analyze --model openvla ...`` runs, the lifecycle layer
spawns this in the background (or attaches to it if a user already
started it manually) and dispatches RPC over a Unix-domain ZMQ socket.
