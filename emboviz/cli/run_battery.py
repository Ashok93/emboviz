...
from emboviz.cli._loaders import load_model, load_scene
from emboviz.core.results import Severity
from emboviz.coverage.gap_detector import detect_gaps
...
from emboviz.taxonomy.object_categories import NOUN_CATEGORIES
...
def main() -> int:
    ...
    if args.dataset == "bridge":
        ...
        from emboviz.datasets.lerobot_bridge import BridgeEpisodeSource, DATASET_REPO
