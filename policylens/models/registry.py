...
def get_model(name: str) -> Callable[..., VLAModel]:
    ...
    # `policylens` import cheap (no torch at top level) while still letting
...
def _try_lazy_register(name: str) -> None:
    ...
    builtin = {
        "openvla-7b": "policylens.models.openvla",
        "openvla": "policylens.models.openvla",
        "mock": "policylens.models.mock",
        # "pi0": "policylens.models.pi0",      # future
        # "gr00t": "policylens.models.gr00t",  # future
    }
