...
This is the ONLY file where OpenVLA-specific code lives. Adding a new VLA
family means writing an analogous file in this directory; no other module
in the package mentions OpenVLA by name.

Heavy imports (torch, transformers) are deferred to `__init__` so just
importing `policylens.models.openvla` doesn't load 7B parameters.
"""
...
from policylens.models.registry import register_model
