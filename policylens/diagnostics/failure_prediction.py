...
P(failure) curve over a rollout — the 'PolicyLens warned you at frame 47'
...
from policylens.probes.base import LinearProbe
from policylens.probes.store import load_probe
    ...
    def run(self, model: VLAModel, scene: Scene) -> DiagnosticResult:
        ...
        if p_fail >= self.critical_threshold:
            ...
            verdict = (
                ...
                f"PolicyLens flags this frame as high-risk for failure."
            )
