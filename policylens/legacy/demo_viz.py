...
from policylens.action_viz import ActionArrow
from policylens.attention_grounding import (
    AttentionGroundingResult,
    HeadLanguageSensitivity,
)
from policylens.coverage_analysis import CoverageGap
...
def _render_header(p: FailureDemoPayload, out: Path) -> Path:
    ...
    ax.axis("off")
    # Title
    ax.text(0.0, 1.0, "PolicyLens — Real Failure Scenario", fontsize=22,
